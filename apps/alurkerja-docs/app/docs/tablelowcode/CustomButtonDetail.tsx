    ...
    >
      <CodePreview
        ...
        code={`<TableLowcode
          ...
          search={search}
          setSearch={setSearch}
          customButtonDetail={(Modal,Button, row) => <div>ini id {row.id}</div>}
        />`}
